...
> **Runtime correction (active):** `docs/5-6-runtime-correction.md` is binding. WP-010 gates backend product work; WP-500 gates frontend product work. Older packets that conflict with its runtime/test policy are superseded.
...
| M0.1 | L0 | Knowledge Source & Data Ingestion | Kiểm kê `docs/knowledge`, source registration, seed mapping, import và RAG indexing | ALL_CAPABILITIES | WP-007, WP-008 |
...
| M0.4 | L0 | Backend Runtime Scaffold | FastAPI scaffold, snake_case package và leaf-module convention | ALL_CAPABILITIES | WP-010 |
| M1.1 | L1 | Session, Config & Feedback | Foundation APIs dùng chung | ALL_CAPABILITIES | WP-101 |
| M1.2 | L1 | Knowledge & Content | Retrieval, content workflow, conflict | PC-01 | WP-102 |
...
| M2.1 | L2 | Knowledge Tools | Search và fallback | PC-01 | WP-201 |
...
| M3.1 | L3 | AI Provider Abstraction | LLM/embedding adapters | ALL_CAPABILITIES | WP-301 |
| M3.2 | L3 | AI Orchestration Core | Context, guardrail, planning, explainability | ALL_CAPABILITIES | WP-302 |
...
| M5.0 | L5 | Frontend Runtime Scaffold | Vite/React/TypeScript và Vitest cho chat/admin | ALL_CAPABILITIES | WP-500 |
...
| M2.3 | ARCH-06, INT-06, INT-07 | get_specialty_list, get_doctor_list, get_available_slots, create_appointment, lookup_appointment |
...
| M3.2 | ARCH-05, ARCH-07, INT-05, INT-07 | ReasoningResultDTO, PlanningResultDTO, ObservationResultDTO, ConversationResultDTO, ExplainabilityResultDTO, GroundingFallbackBehavior |
...
| WP-010 | Backend runtime scaffold and package normalization | L0/M0.4 | ALL_CAPABILITIES | API | M | WP-009 |
| WP-101 | Session, configuration and feedback foundation services | L1/M1.1 | ALL_CAPABILITIES | API | M | WP-006, WP-009, WP-010 |
...
| WP-301 | LLM provider abstraction | L3/M3.1 | ALL_CAPABILITIES | AI-CORE | M | WP-201, WP-202, WP-203, WP-204 |
| WP-302 | Guardrails, context and orchestration core | L3/M3.2 | ALL_CAPABILITIES | AI-CORE | L | WP-301, WP-201, WP-202, WP-203, WP-204 |
...
| WP-500 | Frontend runtime scaffold and test harness | L5/M5.0 | ALL_CAPABILITIES | FE | M | WP-009 |
| WP-501 | Shared chat client, SSE and channel shells | L5/M5.1 | ALL_CAPABILITIES | FE | L | WP-500, WP-401, WP-402, WP-403, WP-404 |
...
| 4 — AI | WP-301–WP-306 | Provider abstraction, guardrails và pipelines | Toàn bộ tools pass | AI behavior, safety, grounding tests pass |
...
|---|---|
| L0 | Manifest/scaffold checks; migration clean-run; RLS/secret tests; source allowlist; seed/RAG metadata, provenance, approval, idempotency và index checks |
...
| L3 | AI behavior, grounding, citation, prompt-injection/PII, emergency deterministic path, provider outage |
